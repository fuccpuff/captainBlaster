...
/*  »змените снар€д. »змените скорость снар€да, скорострельность, траекторию движени€
 *  —делайте так, чтобы игрок мог стрел€ть сразу двум€ снар€дами.
 *  ”скорьте спаун метеоров со временем
 *  ƒобавьте другие типы метеоров
 *  ѕопробуйте дать игроку дополнительное здоровье или защитный щит
 *  ѕопробуйте игроку дать возможность двигатьс€ и по вертикали и по горизонтали
 */
